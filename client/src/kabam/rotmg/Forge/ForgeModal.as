...
public class ForgeModal extends EmptyFrame {
    ...
    public function ForgeModal(_arg1:Boolean = false) {
    ...
    public static function getText(_arg1:String, _arg2:int, _arg3:int, _arg4:Boolean):TextFieldDisplayConcrete {
        var _local5:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(18).setColor(0xFFFFFF).setTextWidth(((ForgeModal.modalWidth - (TEXT_MARGIN * 2)) - 10));
    ...
    override protected function makeModalBackground():Sprite {
        ...
        this.buyButton = new LegacyBuyButton("", 16, 20, Currency.GOLD);
