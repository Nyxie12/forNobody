...
public class ClassDetailView extends Sprite
{
    ...
    public function setNextGoal(param1:String, param2:int) : void
    {
        ...
        if(this.showNextGoal)
        {
            ...
            this.nextGoalDetailText.x = 344 / 2 - this.nextGoalDetailText.width / 2;
    ...
    {
        this.classNameText.x = 344 / 2 - this.classNameText.width / 2;
        this.classNameText.y = 110;
        this.classDescriptionText.y = this.classNameText.y + this.classNameText.height + 5;
        this.classDescriptionText.x = 344 / 2 - this.classDescriptionText.width / 2;
        ...
        this.questCompletedStars.x = 205 + 18;
        ...
        this.nextGoalText.x = 344 / 2 - this.nextGoalText.width / 2;
