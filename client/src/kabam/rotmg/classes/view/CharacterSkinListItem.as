...
public class CharacterSkinListItem extends Sprite {
    ...
    private const background:SliceScalingBitmap = makeBackground();
    private var BackgroundButton:SliceScalingBitmap;
    ...
    private function makeBackground() : SliceScalingBitmap
    {
        BackgroundButton = SliceScalingBitmap(TextureParser.instance.getSliceScalingBitmap("UI","popup_content_inset",155));
        BackgroundButton.width = 420;
    ...
    {
        this.background.transform.colorTransform = this.getColorTransform();
    }
    ...
    private function getColorTransform() : ColorTransform
    {
        ...
        {
            return new ColorTransform(1.5,1.5,1.5);
        }
        return new ColorTransform(1.2,1.2,1.2);
    }
