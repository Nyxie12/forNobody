...
public class CreateNewCharacterRect extends CharacterRect
{
    ...
    public function CreateNewCharacterRect(param1:PlayerModel)
    {
        ...
        if(param1.getNumStars() != FameUtil.maxStars())
        {
            ...
            super.makeTagline(new LineBuilder().setParams("CreateNewCharacterRect.tagline",{"remainingStars":_loc2_}));
    ...
    public function makeBitmap() : void
    {
        ...
        var _loc3_:* = 0.8;
        this.bitmap_.scaleY = _loc3_;
        this.bitmap_.scaleX = _loc3_;
        this.bitmap_.alpha = 3;
        this.bitmap_.x = 100;
        this.bitmap_.y = 15;
