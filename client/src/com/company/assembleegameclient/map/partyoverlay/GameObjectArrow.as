...
public class GameObjectArrow extends Sprite {
    ...
    public function correctQuestNote(_arg_1:Rectangle):Rectangle {
        ...
        if (stage.scaleMode == StageScaleMode.NO_SCALE) {
            this.scaleY = this.scaleX = ((stage.stageWidth < stage.stageHeight ? stage.stageWidth : stage.stageHeight) / 600) / Parameters.data_["mscale"];
        }
        else {
            this.scaleX = 1;
            this.scaleY = 1;
        }
        _local_2.right = _local_2.right - ((800 - this.go_.map_.gs_.hudView.x) * stage.stageWidth / 800) / Parameters.data_["mscale"];
        return _local_2;
    }
