...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5) : BitmapData
    {
        ...
        if(_local8 == null && _local9.hasOwnProperty("@Divine"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xD0DEEC,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("@Quirk"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x39ff14,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("@VeryRare"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x02a4d3,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("@legendary"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xFFFF00,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("@Artifact"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xFFA500,_arg4,_arg5);
        }
