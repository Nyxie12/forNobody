...
public class SavedCharactersList extends Event
{
    ...
    {
        var _local2:SavedCharacter = null;
    ...
    private function parseUserData(_arg1:XML) : void
    {
        ...
        this.editorMinRank = _arg1.EditorMinRank;
    }
    ...
    private function parseCharacterData() : void
    {
        ...
        var _loc3_:int = 0;
        var _loc2_:* = this.charsXML_.Char;
    ...
    private function parseCharacterStatsData() : void
    {
        var _local2:XML = null;
        var _local3:int = 0;
        var _local4:CharacterStats = null;
    ...
    public function bestLevel(_arg1:int) : int
    {
        ...
        return _local2 == null?int(0):int(_local2.bestLevel());
    }

    public function bestOverallLevel() : int
    {
        var _local2:CharacterStats = null;
        var _local1:int = 0;
    ...
    {
        var _local2:CharacterStats = this.charStats_[_arg1];
        return _local2 == null?int(0):int(_local2.bestFame());
    }
