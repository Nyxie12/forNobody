package com.company.assembleegameclient.ui.tooltip
{
   ...
   public class ClassToolTip extends ToolTip
   {
      ...
      public function ClassToolTip(_arg1:XML, _arg2:PlayerModel, _arg3:CharacterStats)
      {
         ...
         this.showUnlockRequirements = Boolean(Boolean(this.shouldShowUnlockRequirements(_arg2,_arg1)));
         ...
         this.nameText_ = new TextFieldDisplayConcrete().setSize(13).setColor(2960685);
         ...
         this.descriptionText_ = new TextFieldDisplayConcrete().setSize(13).setColor(2960685).setWordWrap(true).setMultiLine(true).setTextWidth(174);
         ...
         if(this.showUnlockRequirements)
         {
            this.toUnlockText_ = new TextFieldDisplayConcrete().setSize(13).setColor(2960685).setTextWidth(174).setBold(true);
            ...
            for each(_local9 in _arg1.UnlockLevel)
            {
               ...
               {
                  _local8.pushParams(TextKey.TO_UNLOCK_REACH_LEVEL,{"typeToDisplay":ObjectLibrary.typeToDisplayId_[_local11]});
               }
            }
